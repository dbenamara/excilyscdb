...
@Configuration
@ComponentScan(basePackages = {"fr.excilys.services","fr.excilys.dao","fr.excilys.servlet","test.fr.excilys.dao","fr.excilys.test.mapper","fr.excilys.mapper","fr.excilys.dto", "fr.excilys.model", "fr.excilys.controller", "fr.excilys.springconfig"})
...
public class AppConfig implements WebApplicationInitializer {
	...
	public void onStartup(ServletContext servletCxt) {
		...
		acwac.register(WebConfig.class,AppConfig.class,SpringSecurityInitializer.class,WebSecurityConfig.class);
		
		acwac.setServletContext(servletCxt);
		//acwac.refresh();
		
		DispatcherServlet servlet = new DispatcherServlet(acwac);
		ServletRegistration.Dynamic registration = servletCxt.addServlet("Login", servlet);
